...
const TelaWhatsapp = require('../renderer/elo/tela-whatsapp')
const demoWhats = { estado: 'open', provedor: 'evolution', ativo: true, modo: 'evolution' }
...
const TELAS = {
  ...
  '/admin/whatsapp': () => TelaWhatsapp.htmlWhatsapp(demoWhats, estado),
