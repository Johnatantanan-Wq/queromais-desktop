...
const { SECOES } = require('./menu-base')
...
function listas() {
  const pedidos = [
    { id: 'ped-1043', numero: '1043', hora: '20:18', cliente: 'Sandra Reis', canal: 'Delivery', status: 'Novo', valor: 112.80, filtro: 'novo', etapa: 'analise', entrouHaMin: 2, pagamento: 'Pix', telefone: '(75) 98811-7788', endereco: 'Rua das Palmeiras, 45 — Centro', taxa: 8.00, desconto: 0, forma: 'Pix', esperaMin: 2, enderecoCampos: {"rua":"Rua das Palmeiras","numero":"45","complemento":"","bairro":"Centro","cidade":"Valença","uf":"BA","cep":"45400-000","referencia":""}, itens: ['1x Pizza Portuguesa G', '1x Borda recheada', '1x Refrigerante 2L'] },
    { id: 'ped-1042', numero: '1042', hora: '20:12', cliente: 'Maria Silva', canal: 'Delivery', status: 'Em produção', valor: 89.90, filtro: 'producao', etapa: 'producao', entrouHaMin: 8, pagamento: 'Pix', telefone: '(75) 98811-0001', endereco: 'Rua das Flores, 120 — Centro', taxa: 8.00, desconto: 5.00, forma: 'Pix', esperaMin: 8, enderecoCampos: {"rua":"Rua das Flores","numero":"120","complemento":"apto 302","bairro":"Centro","cidade":"Valença","uf":"BA","cep":"45400-000","referencia":"ao lado da praça"}, itens: ['1x Pizza Calabresa G', '1x Refrigerante 2L'] },
    { id: 'ped-1041', numero: '1041', hora: '20:05', cliente: 'João Pereira', canal: 'Balcão', status: 'Pronto', valor: 54.00, filtro: 'pronto', etapa: 'pronto', entrouHaMin: 15, pagamento: 'Cartão', telefone: '(75) 98811-0002', endereco: null, taxa: 0, desconto: 0, forma: 'Cartão', esperaMin: 15, itens: ['1x Pizza Chocolate M'] },
    { id: 'ped-1040', numero: '1040', hora: '19:58', cliente: 'Carla Nunes', canal: 'Delivery', status: 'Em entrega', valor: 132.40, filtro: 'entrega', etapa: 'transito', entrouHaMin: 22, pagamento: 'Dinheiro', forma: 'Dinheiro', esperaMin: 22, itens: ['2x Pizza Calabresa G', '1x Cerveja long neck', '1x Borda recheada', '1x Água'] },
    { id: 'ped-1039', numero: '1039', hora: '19:22', cliente: 'Mesa 7', canal: 'Mesa', status: 'Em produção', valor: 128.50, filtro: 'producao', etapa: 'producao', entrouHaMin: 31, pagamento: 'Na entrega', contaAberta: true, forma: null, esperaMin: 31, itens: ['2x Pizza Portuguesa G'] },
    { id: 'ped-1038', numero: '1038', hora: '19:10', cliente: 'Rafael Souza', canal: 'Delivery', status: 'Novo', valor: 76.30, filtro: 'novo', etapa: 'analise', entrouHaMin: 12, pagamento: 'Cartão', forma: 'Cartão', esperaMin: 12, enderecoCampos: {"rua":"Av. Beira Mar","numero":"900","complemento":"","bairro":"Praia de Guaibim","cidade":"Valença","uf":"BA","cep":"45400-000","referencia":""}, itens: ['1x Pizza Calabresa M', '1x Refrigerante lata'] },
    { id: 'ped-1037', numero: '1037', hora: '18:47', cliente: 'Ana Paula Dias', canal: 'Retirada', status: 'Pronto', valor: 45.00, filtro: 'pronto', etapa: 'pronto', entrouHaMin: 19, pagamento: 'Pix', forma: 'Pix', esperaMin: 19, itens: ['1x Pizza Chocolate M'] },
    { id: 'ped-1036', numero: '1036', hora: '18:30', cliente: 'Pedro Henrique', canal: 'Delivery', status: 'Entregue', valor: 98.70, filtro: 'entregue', etapa: 'entregue', entrouHaMin: 62, pagamento: 'Pix', forma: 'Pix', esperaMin: 62, itens: ['1x Pizza Portuguesa G', '1x Refrigerante 2L'] },
    { id: 'ped-1035', numero: '1035', hora: '18:05', cliente: 'Luiza Martins', canal: 'Delivery', status: 'Cancelado', valor: 62.00, filtro: 'cancelado', etapa: null, entrouHaMin: 88, pagamento: 'Pix', forma: 'Pix', esperaMin: 88, itens: ['1x Pizza Calabresa M'] },
  ]
