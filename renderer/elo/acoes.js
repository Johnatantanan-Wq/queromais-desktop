...
const DESTINOS = {
  ...
  'despachar': { rota: '/admin/despacho', o: 'despachar o pedido' },
  'despachar-bairro': { rota: '/admin/despacho', o: 'despachar o bairro' },
  'despachar-rota': { rota: '/admin/despacho', o: 'despachar em rota' },
  'despachar-selecionados': { rota: '/admin/despacho', o: 'despachar os selecionados' },
